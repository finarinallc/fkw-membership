    ...
    <?php if ( !empty( $points ) ) { ?>
    <h2>Current Active Point Intervals</h2>
    <table class="wp-list-table widefat fixed striped">
        ...
        <tbody>
            ...
            <tr>
				...
				<td>
					<a href="#" data-points-id="<?php echo $point['id']; ?>" class="edit-points-interval-btn button">Edit</a>
					<a href="#" data-points-id="<?php echo $point['id']; ?>" class="delete-points-interval-btn button">Delete</a>
				</td>
            </tr>
            <?php } ?>
        </tbody>
...
<script>
	...
	function openModal(title) {
		...
		if( title == 'Add Points Interval' || title == 'Edit Points Interval' ) {
			pointsIntervalForm.querySelector('.delete-fields-group').style.display = 'none';
			pointsIntervalForm.querySelector('.modify-fields-group').style.display = 'block';
		} else if ( title == 'Delete Points Interval' ) {
			pointsIntervalForm.querySelector('.delete-fields-group').style.display = 'block';
			pointsIntervalForm.querySelector('.modify-fields-group').style.display = 'none';
		}

		pointsIntervalModal.style.display = 'block';
	}

	function closeModal() {
		pointsIntervalModal.style.display = 'none';
	}
